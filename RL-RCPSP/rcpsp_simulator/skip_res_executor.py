...
class Skip_res_executor(object):
    def __init__(self, jobdag, resource_variant):
        ...
        # 当前总资源矩阵
        self.total_resource_now = np.array([0, 0, 0, 0])
        # 时间信息
        self.walltime = 0
    ...
    def advance_time(self):
        ...
        #     print(1)
        self.total_resource_now = self.resource_variant[self.walltime]
    ...
    def break_operation(self):
        # print('break')
        # 999代表break，下面这行只是为了方便与normal res env的互相验证
        self.action_sequence.append(999)
        # 重置当前资源矩阵和资源消耗矩阵
        ...
        for task in wait_remove_task:
            ...
            # 要把jobdag中节点的condition也设置，不然check runable node idx会出错
