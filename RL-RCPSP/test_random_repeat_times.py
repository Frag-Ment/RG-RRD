...
writer = SummaryWriter("runs/test_l4_random_repeat_times_vf1")
writer.add_text(
    "hyperparameters",
...
n_train_instances = dataloader_train.num_instances
...
for update in tqdm(range(1, num_updates + 1)):
    ...
    for step in range(0, args.num_steps):
        ...
        for env_idx in range(args.num_envs):
            ...
            reward = - reward / 10
            if done == 1:
                adj, fea, res, var = dataloader_train.read_instance(random.randint(0, n_train_instances-1))
    ...
    if update % 10 == 0:
        print('saved')
        save_model_name = 'saves/' + args.use_dataset + '_' + 'random_repeat_times' + str(update) + '.pt'
